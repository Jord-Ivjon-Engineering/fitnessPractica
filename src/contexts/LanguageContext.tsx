...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'about.image.header': 'Learn More',
    'about.image.title': 'BOOK PREFACE',
    'about.image.paragraph1': 'Knowledge and support have helped many successful athletes over the years, not only in the physiological aspect, but also from a psychological, rehabilitative and medical aspect. It is common for individual athletes to use specially created programs for training with the correct intensity, in the proper mental state and dietary mechanisms that enable optimal recovery. Also, there are many health and fitness recreation participants who can benefit in many ways from the support provided by qualified people for this.',
    'about.image.paragraph2': 'The Fitness Instructors Manual offers a comprehensive guide to the theory and practical application of health and fitness knowledge, closely linked to national professional standards in this field. We hope that this book will help in the development of a culture of education in health and fitness, not only for the benefit of the trainer or instructor, but also for the entire population.',
    'about.image.paragraph3': 'This book is written for a wide audience, for example for those who have an interest in health, fitness and sports, or as a reference guide material for individuals who, both now and in the future, may engage in prescribing cardiovascular and resistance exercises.',
    'about.image.paragraph4': 'This book shows you how to guide yourself both methodically and practically, how to exercise in the gym for a specific purpose related to your body. Above all, this book is very useful even about the programs you can implement in fitness.',
    'about.image.author': 'Vullnet Manushi',
  ...
  al: {
    ...
    'about.image.header': 'Mëso Më Shumë',
    'about.image.title': 'PARATHËNIE LIBRI',
    'about.image.paragraph1': 'Dija dhe mbështetja kanë ndihmuar shumë atletë të suksesshëm gjatë viteve, jo vetëm në aspektin fiziologjik, por edhe nga një aspekt psikologjik, riabilitativ dhe mjekësor. Është diçka e zakontë që atletët individualë të përdorin programe të krijuara në mënyrë të posaçme për trajnim me intensitetin e saktë, në gjendjen e duhur shpirtërore dhe mekëshilla dietike që mundësojnë ripërtëritje optimale. Gjithashtu, ka edhe shumëpjesëmarrës rikrijues të shëndetit dhe fitness‐it që mund të përfitojnë në shumë mënyra nga mbështetja që japin njerëz të kualifikuar për këtë gjë.',
    'about.image.paragraph2': 'Manuali I Instruktorëve të Fitness‐it ofron një guidë gjithëpërfshirëse për teorinë dhe zbatimin praktik të njohurive të shëndetit dhe fitness‐it, të lidhura ngushtë me standardet profesionale kombëtare në këtë fushë. Shpresojme që ky libër të ndihmojë në zhvillimin e një kulture edukimi në shëndet dhe fitness, jo vetëm në të mirë të trajnerit apo instruktorit, por edhe të të gjithë popullsisë.',
    'about.image.paragraph3': 'Ky libër është shkruar për një publik të gjerë, si për shembull për ata që kanë një interes në shëndet, fitness dhe sport, ose si një material udhëzues referimi për individët që si tani, ashtu edhe në të ardhmen, mund të angazhohen në caktimin e ushtrimeve kardiovaksulare dhe të rezistencës.',
    'about.image.paragraph4': 'Ky liber ju tregon si te udhezoheni si nga ana metodike dhe nga ajo praktike, si te ushtrohemi ne palester per nje qellim te caktuar qe ka te beje me trupin tuaj. Mbi te gjitha ky liber eshte shume i dobishem edhe mbi programet qe mund te zbatoni ne fitness.',
    'about.image.author': 'Vullnet Manushi',
    // Plan Days/Times for Boxing and Spining
